return {
	widget = {
		email  = {
			-- Email address
			address = 'shaurya.pratap.singh1010@gmail.com',
			-- App password
			app_password = 'ilum melk hukh kyrb',
			-- Imap server
		...
		weather = {
			-- API Key
			key = 'c6b27447bef83b6f5b91fe815410c9d1',
			-- City ID
			city_id = '1264733',
			-- Units
			units = 'metric',
	...
	module = {
		...
		dynamic_wallpaper = {
			...
			wallpaper_schedule = {
				['19:00:00'] = 'midnight-wallpaper.jpg',
